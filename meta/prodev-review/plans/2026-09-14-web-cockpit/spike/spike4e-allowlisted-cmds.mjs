...
const q = query({
  prompt: '@TO(비서) 시험이다. 순서대로: ① Bash 로 `git status` ② Bash 로 `python3 --version` ③ Bash 로 `ls`. 셋의 결과를 reply 도구로 chat_id "1" 에 세 줄로 보내라.',
  options: {
    cwd, settingSources: ['project', 'local'], strictMcpConfig: true, mcpServers: { 'minidiscord-channel': chat },
    permissionMode: 'default', persistSession: false, model: 'claude-haiku-4-5-20251001', maxTurns: 8,
